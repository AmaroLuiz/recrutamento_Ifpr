...
public class JwtUtil {
    ...
    public String generateToken(Long alunoId) {
        return Jwts.builder()
                .setSubject(String.valueOf(alunoId)) // Define o nome de usuário como o assunto do token
    ...
    public String extrairIdToken(String token) {
    ...
    public boolean validateToken(String token, String username) {
        ...
        final String extractedUsername = extrairIdToken(token);
